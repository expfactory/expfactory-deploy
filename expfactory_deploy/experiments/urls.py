...
urlpatterns = [
    ...
    path("serve/<int:assignment_id>/instructions", views.ServeInstructions.as_view(), name="instructions"),
    path("serve/preview/<int:battery_id>/consent", views.PreviewConsent.as_view(), name="preview-consent"),
    path("serve/preview/<int:battery_id>/instructions", views.PreviewInstructions.as_view(), name="preview-instructions"),
