...
urlpatterns = [
    ...
    path('experiment_repo/<int:pk>/', views.ExperimentRepoDetail.as_view(), name='experiment-repo-detail'),
    path('experiment_repo/add/', views.find_new_experiments, name='experiment-repo-create'),
    path('experiment_repo/<int:pk>/update/', views.ExperimentRepoUpdate.as_view(), name='experiment-repo-update'),
    path('experiment_repo/<int:pk>/delete/', views.ExperimentRepoDelete.as_view(), name='experiment-repo-delete'),
    ...
    path('battery/create/template', views.BatteryCreate.as_view(), name='battery-create'),
    path('battery/<int:pk>/update/', views.BatteryUpdate.as_view(), name='battery-update'),
    path('battery/<int:battery_id>/deploy/', views.BatteryCreate.as_view(), name='battery-create'),
]
