...
mean_accuracy__thresholds = {
    ...
    "span": {"response": 0.5, "processing": 0.5},
    "spatial_cueing": {"valid": 0.85, "invalid": 0.75, "nocue": 0.8, "doublecue": 0.8},
    "spatial_ts": {"tswitch_cswitch": 0.85, "tstay_cstay": 0.9, "tstay_cswitch": 0.9},
    "stop_signal": 0.9,
...
omission_rate__thresholds = {
    ...
    "spatial_ts": {"tswitch_cswitch": 0.1, "tstay_cstay": 0.1, "tstay_cswitch": 0.1},
    "stop_signal": 0.1,
    "stroop": 0.1,
    "visual_search": {
        ("conjunction", 8.0): 0.1,
